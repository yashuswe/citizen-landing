        ...
        <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            <div className="max-w-lg">
              ...
              <p className="mt-4 text-gray-600 text-lg">
                Arpan Srivastava is a co-founder and Director at Citizenwave. He is also the CEO of DigitalWins, one of India&apos;s leading Martech companies with clients including Indian Terrain, FabIndia, and Aditya Birla Group. In his prior role at Cadentic Consulting Inc. in the US, he spearheaded sales, securing partnerships with notable clients like IBM, Shell, and Verizon. During his college
